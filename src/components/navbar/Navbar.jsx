  ...
  return (
    <nav className="bg-blue-500 py-2 text-white flex justify-around">
      ...
      <ul className="flex gap-2">
        ...
        <li className="hover:scale-105 transition-all duration-300 hover:text-gray-300"><Link href={"/dashboard/portfolio"}>Portfolio</Link></li>
        <li className="hover:scale-105 transition-all duration-300 hover:text-gray-300"><Link href={"/dashboard/funds"}>Funds</Link></li>
